...
SELECT  COUNT(*)                  AS TOTAL_FILAS,
		COUNT(DISTINCT event_id)  AS PARTIDOS_UNICOS
FROM PARTIDOS

-- RETO. Escribe como comentario una pregunta analitica que quieras seguir
-- durante el curso usando este dataset.
-- Pregunta: existe relacion entre las condiciones climaticas (temperatura y
-- velocidad del viento, columna weather) y la cantidad total de goles
-- anotados en un partido (home_score + away_score)?
